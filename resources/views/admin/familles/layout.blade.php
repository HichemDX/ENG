...
<body class="overflow-x-hidden">
  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-lg w-screen h-26 fixed top-0">
        ...
        <div>
          <ul class="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <!-- Dropdown menu -->
              <div id="dropdown" class="absolute top-16  z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
