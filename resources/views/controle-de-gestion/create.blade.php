                            ...
                            <form action="{{ route('controle-de-gestion.store') }}" method="POST">
                                ...
                                <center>
                                    <label for="large-input"
                                        class=" flex  font-medium text-gray-900 dark:text-white  text-3xl px-6 py-3">Flash
                                ...
                                <div class="mb-6">
                                    <label for="large-input"
                                        class=" flex  font-medium text-gray-900 dark:text-white  text-3xl px-6 py-3">Description
                                    </label>
